...
@protonprotocol/cli/0.2.0 darwin-x64 node-v12.19.0
$ proton --help [COMMAND]
USAGE
  $ proton COMMAND
...
...
_See code: [src/commands/bootstrap.ts](https://github.com/ProtonProtocol/proton-cli/blob/v0.2.0/src/commands/bootstrap.ts)_
...
_See code: [src/commands/hello.ts](https://github.com/ProtonProtocol/proton-cli/blob/v0.2.0/src/commands/hello.ts)_
